...
/**
* A class for CRUD the Debit Notes requests
*/

class DebitNotes extends Authentication{
	...
	/**
	DebitNotes array data structure
	[
	...
	*/
	...
	/**
	* Count DebitNotes of the Company
	* @return json
